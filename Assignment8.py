...
print("Search Trie: ", timeit.Timer(seachTrie).timeit(number=1))
print("Search Brute Force: ", timeit.Timer(searchBruteForce).timeit(number=1))
print("Search KMP: ", timeit.Timer(searchKMP).timeit(number=1))